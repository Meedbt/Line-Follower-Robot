...
const uint16_t DUREE_MIN_DEMI_TOUR_MS = 450;
const uint16_t DUREE_MAX_DEMI_TOUR_MS = 1600;
    ...
    <section class="grid">
      ...
      <article class="card wide">
        ...
        <label>
          ...
          <input id="target" type="range" min="1" max="12" step="1" value="3" oninput="majReglages()">
        </label>
        <label>
        ...
        <label>
          ...
          <input id="seq" type="text" value="S" maxlength="31" oninput="majReglages()">
        </label>
        <label>
        ...
        <label>
          ...
          <input id="seqGo" type="text" value="S" maxlength="31" oninput="majReglages()">
        </label>
        <label>
          <div class="row"><span>Sequence retour</span><output id="seqBackOut">S</output></div>
          <input id="seqBack" type="text" value="S" maxlength="31" oninput="majReglages()">
        </label>
        <label>
        ...
        <label>
          ...
          <input id="uInter" type="range" min="0" max="20" step="1" value="0" oninput="majReglages()">
        </label>
        <label>
        ...
        <label>
          ...
          <input id="finalInter" type="range" min="0" max="20" step="1" value="0" oninput="majReglages()">
        </label>
      </article>
...
void appliquerReglagesDepuisWeb()
{
  ...
  if (serveur.hasArg("target")) {
    cibleMarqueurs = constrain(serveur.arg("target").toInt(), 1, 12);
  }
  ...
  if (serveur.hasArg("uInter")) {
    demiTourApresIntersection = constrain(serveur.arg("uInter").toInt(), 0, 20);
  }
  ...
  if (serveur.hasArg("finalInter")) {
    arretFinalApresIntersection = constrain(serveur.arg("finalInter").toInt(), 0, 20);
  }
